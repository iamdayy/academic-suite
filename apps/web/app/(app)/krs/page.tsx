...
export default function KrsHistoryPage() {
  ...
  return (
      <div>
        <h1 className="text-3xl font-bold mb-6">Riwayat Kartu Rencana Studi (KRS)</h1>
            ...
            <TableBody>
              {krsHeaders.map((header) => (
                <TableRow key={header.id.toString()}>
                  <TableCell>{header.academicYear.year} ({header.academicYear.semester})</TableCell>
                  ...
                  <TableCell>{calculateTotalCredits(header.krsDetails)} SKS</TableCell>
                  <TableCell>
